            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="box-dashboard" style="padding-bottom: 0px">
                    <div class="progress-box" style="padding-bottom: 0px">
                        <div class="info">
                            <span class="name"><?php echo t('campaign_reports', 'Recipients'); ?></span><span class="number"><?php echo CHtml::link($campaign->stats->getProcessedCount(true), $recipientsUrl); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="box box-primary borderless">
    ...
    return CHtml::link($campaign->name, ['campaigns/overview', 'campaign_uid' => $campaign->campaign_uid]);
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="box-dashboard">
                    <ul class="custom-list">
                        <li><span class="cl-span"><?php echo t('campaigns', 'Forwards'); ?></span><span class="cl-span"><?php echo CHtml::link($campaign->countForwards(), $forwardsUrl); ?></span></li>
                        <li><span class="cl-span"><?php echo t('campaigns', 'Abuse reports'); ?></span><span class="cl-span"><?php echo CHtml::link($campaign->countAbuseReports(), $abusesUrl); ?></span></li>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <label><?php echo t('campaigns', 'Email above info to below email address'); ?></label>
                        <div class="input-group">
