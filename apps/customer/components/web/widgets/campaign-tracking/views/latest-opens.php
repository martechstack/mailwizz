...
<div class="box borderless">
    <div class="box-header">
        <div class="pull-left">
            <h3 class="box-title"><i class="fa fa-link" aria-hidden="true"></i><?php echo t('campaign_reports', 'Latest opens'); ?></h3>
        </div>
                    ...
                    <ul class="custom-list">
                        <?php foreach ($models as $model) { ?>
                            <li>
                                ...
                                <span class="cl-span">
                                    <?php echo t('campaign_reports', 'at {date}', ['{date}' => $model->dateAdded]); ?>
                                </span>
                            </li>
                        <?php } ?>
                    </ul>
