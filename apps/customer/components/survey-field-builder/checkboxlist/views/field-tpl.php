...
<div class="field-row" data-start-index="<?php echo $index; ?>" data-field-type="<?php echo $model->type->identifier; ?>">
    ...
    <ul class="nav nav-tabs">
        <li class="active">
            <a href="javascript:;"><span class="glyphicon glyphicon-th-list"></span> <?php echo t('survey_fields', 'Checkboxlist field'); ?></a>
        </li>
    </ul>
    <div class="panel panel-default no-top-border">
        <div class="panel-body">
            ...
            <hr />
            <h4><?php echo t('survey_fields', 'Options'); ?> <a href="javascript:;" class="btn btn-flat btn-primary pull-right btn-checkboxlist-add-option"><?php echo IconHelper::make('create'); ?></a></h4>
            <hr />
            <div class="row">
                <div class="checkboxlist-options-list">
                    <?php if (!empty($model->options)) {
    foreach ($model->options as $optionIndex => $option) { ?>
                        <div class="col-lg-6 checkboxlist-option-row" data-start-index="<?php echo $optionIndex; ?>" data-parent-index="<?php echo $index; ?>">
        ...
        <div class="panel-footer">
            <div class="pull-right">
                <a href="javascript:;" class="btn btn-danger btn-flat btn-remove-checkboxlist-field" data-field-id="<?php echo (int)$model->field_id; ?>" data-message="<?php echo t('survey_fields', 'Are you sure you want to remove this field? There is no coming back from this after you save the changes.'); ?>"><?php echo IconHelper::make('delete'); ?></a>
            </div>
