...
/**
 * SurveyFieldBuilderTypeGeostateResponder
 *
...
/**
 * @property SurveyFieldBuilderTypeGeostate $owner
 */
class SurveyFieldBuilderTypeGeostateResponder extends SurveyFieldBuilderTypeResponder
{
    /**
     * @param CEvent $event
     *
    ...
    protected function buildFieldArray(SurveyFieldValue $model): array
    {
        ...
        return hooks()->applyFilters('survey_field_builder_type_geostate_responder_build_field_array', [
