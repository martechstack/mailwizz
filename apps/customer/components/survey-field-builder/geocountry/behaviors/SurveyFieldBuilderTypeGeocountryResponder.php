...
/**
 * SurveyFieldBuilderTypeGeocountryResponder
 *
...
/**
 * @property SurveyFieldBuilderTypeGeocountry $owner
 */
class SurveyFieldBuilderTypeGeocountryResponder extends SurveyFieldBuilderTypeResponder
{
    /**
     * @param CEvent $event
     *
    ...
    protected function buildFieldArray(SurveyFieldValue $model): array
    {
        ...
        return hooks()->applyFilters('survey_field_builder_type_geocountry_responder_build_field_array', [
