...
<div class="field-row" data-start-index="<?php echo $index; ?>" data-field-type="<?php echo $model->type->identifier; ?>">
    ...
    <ul class="nav nav-tabs">
        <li class="active">
            <a href="javascript:;"><span class="glyphicon glyphicon-th-list"></span> <?php echo t('survey_fields', 'Multiselect field'); ?></a>
        </li>
    </ul>
    <div class="panel panel-default no-top-border">
        <div class="panel-body">
            ...
            <hr />
            <h4><?php echo t('survey_fields', 'Dropdown options'); ?> <a href="javascript:;" class="btn btn-flat btn-primary pull-right btn-multiselect-add-option"><?php echo IconHelper::make('create'); ?></a></h4>
            <hr />
            <div class="row">
    ...
    foreach ($model->options as $optionIndex => $option) { ?>
        ...
        <div class="panel-footer">
            <div class="pull-right">
                <a href="javascript:;" class="btn btn-danger btn-flat btn-remove-multiselect-field" data-field-id="<?php echo (int)$model->field_id; ?>" data-message="<?php echo t('survey_fields', 'Are you sure you want to remove this field? There is no coming back from this after you save the changes.'); ?>"><?php echo IconHelper::make('delete'); ?></a>
            </div>
