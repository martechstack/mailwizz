...
<div class="form-group field-<?php echo $field->type->identifier; ?> state-field wrap-<?php echo strtolower((string)$field->tag); ?>" style="display: <?php echo !empty($visible) ? 'block' : 'none'; ?>">
