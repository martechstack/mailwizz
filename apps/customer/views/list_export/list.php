    ...
    <div class="box box-primary borderless">
        <div class="box-header">
            ...
            <div class="pull-right">
                ...
                <?php echo CHtml::link(IconHelper::make('refresh') . t('app', 'Refresh'), ['list_export/index', 'list_uid' => $list->list_uid], ['class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Refresh')]); ?>
            </div>
            ...
            <div class="row boxes-mw-wrapper">
                <div class="col-lg-4 col-xs-6">
                    <div class="small-box">
                        <div class="inner">
                            <div class="middle">
                                <h3><a href="<?php echo createUrl('list_export/csv', ['list_uid' => $list->list_uid]); ?>" class=""><?php echo t('list_export', 'CSV'); ?></a></h3>
