...
$currentDomain = (string)$controller->getData('currentDomain');
            ...
            <div class="box-header">
                ...
                <div class="pull-right">
                    <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                        ->addIf(CHtml::link(IconHelper::make('create') . t('app', 'Create new'), ['tracking_domains/create'], ['class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Create new')]), !$domain->getIsNewRecord())
                        ->add(CHtml::link(IconHelper::make('cancel') . t('app', 'Cancel'), ['tracking_domains/index'], ['class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Cancel')]))
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="form-group col-lg-6">
                        ...
                        <?php echo $form->dropDownList($domain, 'skipValidation', [0 => t('app', 'No'), 1 => t('app', 'Yes')], $domain->fieldDecorator->getHtmlOptions('skipValidation')); ?>
