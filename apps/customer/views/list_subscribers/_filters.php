    ...
    <div class="box-body">
        <div class="row">
            <div class="col-lg-4">
                ...
                <?php echo CHtml::dropDownList('filter[campaigns][action]', $getFilter['campaigns']['action'], CMap::mergeArray(['' => ''], $subscriber->getCampaignFilterActions()), ['class' => 'form-control']); ?>
            </div>    
            <div class="col-lg-4">
                <label><?php echo t('list_subscribers', 'This campaign'); ?>:</label>
                <?php echo CHtml::dropDownList('filter[campaigns][campaign]', $getFilter['campaigns']['campaign'], CMap::mergeArray(['' => ''], $listCampaigns), ['class' => 'form-control']); ?>
            </div>
            <div class="col-lg-4">
