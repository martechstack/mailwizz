        ...
        <div class="box box-primary borderless">
            ...
            <div class="box-body">
                <div class="callout callout-info">
                    <?php echo t('customers', 'Please provide your email address where we will send you a confirmation email in order to finish this process.'); ?>
                </div>
                <?php
                /**
            ...
            <div class="box-footer">
                <div class="pull-left">
                    <a href="<?php echo createUrl('guest/index'); ?>" class="btn btn-default btn-flat"><?php echo t('customers', 'Go to login'); ?></a>
                </div>
                <div class="pull-right">
                    <button type="submit" class="btn btn-default btn-submit"><?php echo t('app', 'Submit'); ?></button>
                </div>
                <div class="clearfix"><!-- --></div>
            </div>
        </div>
