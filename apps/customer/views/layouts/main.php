...
<div class="wrapper">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            <li class="user-header bg-light-blue">
                                <img src="<?php echo $customer->getAvatarUrl(90, 90); ?>" class="img-circle"/>
                                <p>
    ...
    hooks()->doAction('customer_layout_main_sidebar_user_panel', $controller);
            ...
            <?php if (container()->get(OptionCommon::class)->getShowCustomerTimeInfo() && app_version_compare_to('1.3.4.4', '>=')) { ?>
                <div class="timeinfo">
                    <div class="pull-left"><?php echo t('app', 'Local time'); ?></div>
                    <div class="pull-right"><?php echo $customer->dateTimeFormatter->formatDateTime(); ?></div>
