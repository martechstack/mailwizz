...
if (!empty($viewCollection) && $viewCollection->itemAt('renderContent')) {
    if (!$customer->getIsNewRecord() && $twoFaSettings->getIsEnabled()) { ?>
        <ul class="nav nav-tabs" style="border-bottom: 0px;">
            <li class="active"><a href="<?php echo createUrl('subaccounts/update', ['id' => $customer->customer_id]); ?>"><?php echo html_encode(t('app', 'Profile')); ?></a></li>
            <li class="inactive"><a href="<?php echo createUrl('subaccounts/2fa', ['id' => $customer->customer_id]); ?>"><?php echo html_encode(t('app', '2FA')); ?></a></li>
        </ul>
    <?php }
    /**
        ...
        <div class="box box-primary borderless">
            <div class="box-header">
                ...
                <div class="pull-right">
                    <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                        ->addIf(HtmlHelper::accessLink(IconHelper::make('create') . t('app', 'Create new'), ['subaccounts/create'], ['class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Create new')]), !$customer->getIsNewRecord())
                        ->add(HtmlHelper::accessLink(IconHelper::make('cancel') . t('app', 'Cancel'), ['subaccounts/index'], ['class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Cancel')]))
                        ->render(); ?>
                </div>
            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            <?php $registration = container()->get(OptionCustomerRegistration::class); ?>
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <?php echo $form->dropDownList($customer, 'status', $customer->getSubaccountsStatusesArray(), $customer->fieldDecorator->getHtmlOptions('status')); ?>
                ...
                <hr />
                <?php
                $controller->renderPartial('_permissions', [
                    'form'  => $form,
                ]); ?>
                <?php
                /**
