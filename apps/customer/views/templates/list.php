        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ...
                    ->add(CHtml::link(IconHelper::make('upload') . t('email_templates', 'Upload template'), '#template-upload-modal', ['class' => 'btn btn-primary btn-flat', 'data-toggle' => 'modal', 'title' => t('email_templates', 'Upload template')]))
                    ->add(CHtml::link(IconHelper::make('create') . t('app', 'Create new'), ['templates/create'], ['class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Create new')]))
                    ->addIf(CHtml::link(IconHelper::make('export') . t('app', 'Export'), ['templates/export'], ['target' => '_blank', 'class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Export')]), $itemsCount)
                    ->add(CHtml::link(IconHelper::make('refresh') . t('app', 'Refresh'), ['templates/index'], ['class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Refresh')]))
                    ->render(); ?>
            </div>
        ...
        $controller->widget('zii.widgets.grid.CGridView', hooks()->applyFilters('grid_view_properties', [
                    ...
                    'columns' => hooks()->applyFilters('grid_view_columns', [
                        ...
                        [
                            ...
                            'filter'=> CustomerEmailTemplateCategory::getAllAsOptions((int)$template->customer_id),
                        ],
                        [
                            'name'  => 'date_added',
                        ...
                        [
                            ...
                            'buttons'   => [
                                'update' => [
                                    ...
                                    'url'       => 'createUrl("templates/update", array("template_uid" => $data->template_uid))',
                                    'imageUrl'  => null,
                                    'options'   => ['title' => t('app', 'Update'), 'class' => 'btn btn-primary btn-flat'],
                                ],
                                'copy' => [
                                    'label'     => IconHelper::make('copy'),
                                    'url'       => 'createUrl("templates/copy", array("template_uid" => $data->template_uid))',
                                    'imageUrl'  => null,
                                    'options'   => ['title' => t('app', 'Copy'), 'class' => 'btn btn-primary btn-flat'],
                                ],
                                'delete' => [
                                    'label'     => IconHelper::make('delete'),
                                    'url'       => 'createUrl("templates/delete", array("template_uid" => $data->template_uid))',
                                    'imageUrl'  => null,
