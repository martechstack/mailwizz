        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ...
                    ->add(CHtml::link(IconHelper::make('view') . t('campaign_reports', 'View unique opens'), [$controller->campaignReportsController . '/open_unique', 'campaign_uid' => $campaign->campaign_uid], ['class' => 'btn btn-primary btn-flat', 'title' => t('campaign_reports', 'View unique opens only')]))
                    ->addIf(CHtml::link(IconHelper::make('export') . t('campaign_reports', 'Export reports'), [$controller->campaignReportsExportController . '/open', 'campaign_uid' => $campaign->campaign_uid], ['target' => '_blank', 'class' => 'btn btn-primary btn-flat', 'title' => t('campaign_reports', 'Export reports')]), !empty($canExportStats))
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    echo t('campaign_reports', StringHelper::normalizeTranslationString($text), [
                        '{href}' => createUrl('campaign_reports/open_unique', ['campaign_uid' => $campaign->campaign_uid]),
                    ]);
                    ?>
                </div>
            </div>
