        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php $box = BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->addIf($controller->widget('common.components.web.widgets.GridViewToggleColumns', ['model' => $server, 'columns' => ['name', 'hostname', 'username', 'from_email', 'type', 'status']], true), $itemsCount)
