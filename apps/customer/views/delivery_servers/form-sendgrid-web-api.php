...
/** @var DeliveryServerSendgridWebApi $server */
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php echo t('servers', 'Please note that automatic events handling, such as bounces or complaints, is done only if your Sendgrid account is free or at least Bronze.'); ?><br />
                        <?php echo t('servers', 'If you later upgrade to a Bronze account, you will have to delete this delivery server and add it again for automatic handling of events.'); ?><br />
