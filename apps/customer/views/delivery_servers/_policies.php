                        ...
                        <div class="col-lg-6 policy-item">
                            <div class="row">
                                <div class="col-lg-5">
                                    ...
                                    <div class="clearfix"><!-- --></div>
                                    <?php echo CHtml::textField($policyModel->getModelName() . '[' . $i . '][domain]', $policyModel->domain, $policyModel->getHtmlOptions('domain')); ?>
                                </div>
                                <div class="col-lg-5">
                                    <label class="required"><?php echo t('servers', 'Policy'); ?> <span class="required">*</span></label>
                                    <div class="clearfix"><!-- --></div>
                                    <?php echo CHtml::dropDownList($policyModel->getModelName() . '[' . $i . '][policy]', $policyModel->policy, $policyModel->getPoliciesList(), $policyModel->getHtmlOptions('policy')); ?>
                                </div>
                                <div class="col-lg-2">
                                    <label>&nbsp;</label>
                                    <div class="clearfix"><!-- --></div>
    ...
    <div class="col-lg-6 policy-item">
        <div class="row">
            <div class="col-lg-5">
                <label class="required"><?php echo t('servers', 'Domain name'); ?> <span class="required">*</span></label>
                <div class="clearfix"><!-- --></div>
                <?php echo CHtml::textField($policy->getModelName() . '[__#__][domain]', null, $policy->fieldDecorator->getHtmlOptions('domain', ['disabled' => true])); ?>
            </div>
            <div class="col-lg-5">
                <label class="required"><?php echo t('servers', 'Policy'); ?> <span class="required">*</span></label>
                <div class="clearfix"><!-- --></div>
                <?php echo CHtml::dropDownList($policy->getModelName() . '[__#__][policy]', null, $policy->getPoliciesList(), $policy->fieldDecorator->getHtmlOptions('policy', ['disabled' => true])); ?>
            </div>
            <div class="col-lg-2">
                <label>&nbsp;</label>
                <div class="clearfix"><!-- --></div>
