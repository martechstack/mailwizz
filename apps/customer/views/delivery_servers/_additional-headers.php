    ...
    <div class="col-lg-6 header-item">
        <div class="row">
            <div class="col-lg-5">
                <label class="required"><?php echo t('servers', 'Header name'); ?> <span class="required">*</span></label>
                <div class="clearfix"><!-- --></div>
                <?php echo CHtml::textField($server->getModelName() . '[additional_headers][__#__][name]', null, $server->fieldDecorator->getHtmlOptions('additional_headers', ['disabled' => true, 'placeholder' => t('servers', 'X-Header-Name')])); ?>
            </div>
            <div class="col-lg-5">
                <label class="required"><?php echo t('servers', 'Header value'); ?> <span class="required">*</span></label>
                <div class="clearfix"><!-- --></div>
                <?php echo CHtml::textField($server->getModelName() . '[additional_headers][__#__][value]', null, $server->fieldDecorator->getHtmlOptions('additional_headers', ['disabled' => true, 'placeholder' => t('servers', 'Header value')])); ?>
            </div>
            <div class="col-lg-2">
                <label>&nbsp;</label>
                <div class="clearfix"><!-- --></div>
