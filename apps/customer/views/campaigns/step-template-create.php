                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo CHtml::dropDownList($templateUrlActionListFieldMdl->getModelName() . '[' . $index . '][url]', $templateUrlActionListFieldMdl->url, $templateContentUrls, $templateUrlActionListFieldMdl->fieldDecorator->getHtmlOptions('url')); ?>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo CHtml::dropDownList($templateUrlActionListField->getModelName() . '[' . $index . '][field_id]', $templateUrlActionListFieldMdl->field_id, CMap::mergeArray(['' => t('app', 'Choose')], $templateUrlActionListFieldMdl->getCustomFieldsAsDropDownOptions()), $templateUrlActionListFieldMdl->fieldDecorator->getHtmlOptions('field_id')); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo CHtml::dropDownList($templateUrlActionSub->getModelName() . '[' . $index . '][url]', $templateUrlActionSub->url, $templateContentUrls, $templateUrlActionSub->fieldDecorator->getHtmlOptions('url')); ?>
                                                ...
                                                <div class="col-lg-1">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo CHtml::dropDownList($templateUrlActionSub->getModelName() . '[' . $index . '][action]', $templateUrlActionSub->action, $clickAllowedActions, $templateUrlActionSub->fieldDecorator->getHtmlOptions('action')); ?>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo CHtml::dropDownList($templateUrlActionSub->getModelName() . '[' . $index . '][list_id]', $templateUrlActionSub->list_id, $templateListsArray, $templateUrlActionSub->fieldDecorator->getHtmlOptions('list_id')); ?>
            ...
            <div class="box-footer">
                <div class="wizard">
                    <ul class="steps">
                        ...
                        <li class="complete"><a href="<?php echo createUrl('campaigns/setup', ['campaign_uid' => $campaign->campaign_uid]); ?>"><?php echo t('campaigns', 'Setup'); ?></a><span class="chevron"></span></li>
                        <li class="active"><a href="<?php echo createUrl('campaigns/template', ['campaign_uid' => $campaign->campaign_uid]); ?>"><?php echo t('campaigns', 'Template'); ?></a><span class="chevron"></span></li>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <?php echo CHtml::dropDownList($templateUrlActionListField->getModelName() . '[{index}][url]', null, $templateContentUrls, $templateUrlActionListField->fieldDecorator->getHtmlOptions('url')); ?>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <?php echo $form->labelEx($templateUrlActionListField, 'field_id'); ?>
                            <?php echo CHtml::dropDownList($templateUrlActionListField->getModelName() . '[{index}][field_id]', null, CMap::mergeArray(['' => t('app', 'Choose')], $templateUrlActionListField->getCustomFieldsAsDropDownOptions()), $templateUrlActionListField->fieldDecorator->getHtmlOptions('field_id')); ?>
                            <?php echo $form->error($templateUrlActionListField, 'field_id'); ?>
                        </div>
                    </div>
                    <div class="col-lg-4">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <?php echo CHtml::dropDownList($templateUrlActionSubscriber->getModelName() . '[{index}][url]', null, $templateContentUrls, $templateUrlActionSubscriber->fieldDecorator->getHtmlOptions('url')); ?>
                    ...
                    <div class="col-lg-1">
                        <div class="form-group">
                            ...
                            <?php echo CHtml::dropDownList($templateUrlActionSubscriber->getModelName() . '[{index}][action]', null, $clickAllowedActions, $templateUrlActionSubscriber->fieldDecorator->getHtmlOptions('action')); ?>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <?php echo CHtml::dropDownList($templateUrlActionSubscriber->getModelName() . '[{index}][list_id]', null, $templateListsArray, $templateUrlActionSubscriber->fieldDecorator->getHtmlOptions('list_id')); ?>
