    ...
    if (!empty($collection) && $collection->itemAt('renderForm')) {
        ...
        <div class="box box-primary borderless">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo $form->dropDownList($openUnopenFilter, 'action', CMap::mergeArray(['' => ''], $openUnopenFilter->getActionsList()), $openUnopenFilter->fieldDecorator->getHtmlOptions('action')); ?>
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo $form->dropDownList($openUnopenFilter, 'previous_campaign_id', CMap::mergeArray(['' => ''], $campaign->getRelatedCampaignsAsOptions()), $openUnopenFilter->fieldDecorator->getHtmlOptions('previous_campaign_id', ['multiple' => true])); ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo CHtml::dropDownList($openListFieldAct->getModelName() . '[' . $index . '][field_id]', $openListFieldAct->field_id, $openListFieldActionOptions, $openListFieldAct->fieldDecorator->getHtmlOptions('field_id')); ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo CHtml::dropDownList($sentListFieldAct->getModelName() . '[' . $index . '][field_id]', $sentListFieldAct->field_id, $sentListFieldActionOptions, $sentListFieldAct->fieldDecorator->getHtmlOptions('field_id')); ?>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <?php echo CHtml::dropDownList($openAct->getModelName() . '[' . $index . '][action]', $openAct->action, $openAllowedActions, $openAct->fieldDecorator->getHtmlOptions('action')); ?>
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <?php echo CHtml::dropDownList($openAct->getModelName() . '[' . $index . '][list_id]', $openAct->list_id, $openActionLists, $openAct->fieldDecorator->getHtmlOptions('list_id')); ?>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <?php echo CHtml::dropDownList($sentAct->getModelName() . '[' . $index . '][action]', $sentAct->action, $sentAllowedActions, $sentAct->fieldDecorator->getHtmlOptions('action')); ?>
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <?php echo CHtml::dropDownList($sentAct->getModelName() . '[' . $index . '][list_id]', $sentAct->list_id, $sentActionLists, $sentAct->fieldDecorator->getHtmlOptions('list_id')); ?>
            ...
            <div class="box-footer">
                <div class="wizard">
                    <ul class="steps">
                        <li class="complete"><a href="<?php echo createUrl('campaigns/update', ['campaign_uid' => $campaign->campaign_uid]); ?>"><?php echo t('campaigns', 'Details'); ?></a><span class="chevron"></span></li>
                        <li class="active"><a href="<?php echo createUrl('campaigns/setup', ['campaign_uid' => $campaign->campaign_uid]); ?>"><?php echo t('campaigns', 'Setup'); ?></a><span class="chevron"></span></li>
                        <li><a href="<?php echo createUrl('campaigns/template', ['campaign_uid' => $campaign->campaign_uid]); ?>"><?php echo t('campaigns', 'Template'); ?></a><span class="chevron"></span></li>
                        <li><a href="<?php echo createUrl('campaigns/confirm', ['campaign_uid' => $campaign->campaign_uid]); ?>"><?php echo t('campaigns', 'Confirmation'); ?></a><span class="chevron"></span></li>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <?php echo CHtml::dropDownList($openAction->getModelName() . '[{index}][action]', null, $openAllowedActions, $openAction->fieldDecorator->getHtmlOptions('action')); ?>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <?php echo CHtml::dropDownList($openAction->getModelName() . '[{index}][list_id]', null, $openActionLists, $openAction->fieldDecorator->getHtmlOptions('list_id')); ?>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <?php echo CHtml::dropDownList($sentAction->getModelName() . '[{index}][action]', null, $sentAllowedActions, $sentAction->fieldDecorator->getHtmlOptions('action')); ?>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <?php echo CHtml::dropDownList($sentAction->getModelName() . '[{index}][list_id]', null, $sentActionLists, $sentAction->fieldDecorator->getHtmlOptions('list_id')); ?>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <?php echo CHtml::dropDownList($openListFieldAction->getModelName() . '[{index}][field_id]', null, $openListFieldActionOptions, $openListFieldAction->fieldDecorator->getHtmlOptions('field_id')); ?>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <?php echo CHtml::dropDownList($sentListFieldAction->getModelName() . '[{index}][field_id]', null, $sentListFieldActionOptions, $sentListFieldAction->fieldDecorator->getHtmlOptions('field_id')); ?>
