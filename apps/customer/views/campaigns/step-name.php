        ...
        <div class="box box-primary borderless">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
			                ...
			                <?php echo $form->dropDownList($campaign, 'group_id', $groupsArray, $campaign->fieldDecorator->getHtmlOptions('group_id')); ?>
            ...
            <div class="box-footer">
                <div class="wizard">
                    ...
                    <?php } else { ?>
                    <ul class="steps">
                        <li class="active"><a href="<?php echo createUrl('campaigns/update', ['campaign_uid' => $campaign->campaign_uid]); ?>"><?php echo t('campaigns', 'Details'); ?></a><span class="chevron"></span></li>
                        <li><a href="<?php echo createUrl('campaigns/setup', ['campaign_uid' => $campaign->campaign_uid]); ?>"><?php echo t('campaigns', 'Setup'); ?></a><span class="chevron"></span></li>
