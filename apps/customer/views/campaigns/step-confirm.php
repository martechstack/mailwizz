                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
			                    ...
			                    <?php echo $form->dropDownList($campaign->option, 'timewarp_enabled', $campaign->option->getYesNoOptions(), $campaign->option->fieldDecorator->getHtmlOptions('timewarp_enabled')); ?>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
			                    ...
			                    <?php echo $form->dropDownList($campaign->option, 'timewarp_hour', $campaign->option->getTimewarpHours(), $campaign->option->fieldDecorator->getHtmlOptions('timewarp_hour')); ?>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
			                    ...
			                    <?php echo $form->dropDownList($campaign->option, 'timewarp_minute', $campaign->option->getTimewarpMinutes(), $campaign->option->fieldDecorator->getHtmlOptions('timewarp_minute')); ?>
            ...
            <div class="box-footer">
                <div class="wizard">
                    <ul class="steps">
                        ...
                        <li class="complete"><a href="<?php echo createUrl('campaigns/template', ['campaign_uid' => $campaign->campaign_uid]); ?>"><?php echo t('campaigns', 'Template'); ?></a><span class="chevron"></span></li>
                        <li class="active"><a href="<?php echo createUrl('campaigns/confirm', ['campaign_uid' => $campaign->campaign_uid]); ?>"><?php echo t('campaigns', 'Confirmation'); ?></a><span class="chevron"></span></li>
                    ...
                    <div class="actions">
                        <button type="submit" id="is_next" name="is_next" value="1" class="btn btn-primary btn-flat btn-go-next">
                            <?php echo $campaign->getIsAutoresponder() ? IconHelper::make('next') . '&nbsp;' . t('campaigns', 'Save and activate') : IconHelper::make('fa-send') . '&nbsp;' . t('campaigns', 'Send campaign'); ?>
                        </button>
                    </div>
                </div>
            </div>
