...
?>
<!DOCTYPE html>
<html dir="<?php echo $controller->getHtmlOrientation(); ?>">
<head>
    ...
    <body class="<?php echo $controller->getBodyClasses(); ?>">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span><?php echo ($fullName = $user->getFullName()) ? html_encode($fullName) : t('app', 'Welcome'); ?><i class="caret"></i></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li class="user-header bg-light-blue">
                                        <img src="<?php echo $user->getAvatarUrl(90, 90); ?>" class="img-circle"/>
                                        <p>
                                            <?php echo ($fullName = $user->getFullName()) ? html_encode($fullName) : t('app', 'Welcome'); ?>
                                        </p>
                                    </li>
                    ...
                    <div class="user-panel">
                        <?php if (!hooks()->hasActions('backend_layout_main_sidebar_user_panel')) { ?>
                            ...
                            <div class="pull-left info">
                                <p><?php echo ($fullName = $user->getFullName()) ? html_encode($fullName) : t('app', 'Welcome'); ?></p>
                            </div>
                        <?php } else {
    hooks()->doAction('backend_layout_main_sidebar_user_panel', $controller);
                    ...
                    <?php
                    $correctVersion = version_compare(MW_VERSION, '1.3.4.4', '>=');
                    if (container()->get(OptionCommon::class)->getShowBackendTimeInfo() && !empty($correctVersion)) { ?>
                        <div class="timeinfo">
                            <div class="pull-left"><?php echo t('app', 'Local time'); ?></div>
                            <div class="pull-right"><?php echo $user->dateTimeFormatter->formatDateTime(); ?></div>
