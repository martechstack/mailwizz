        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->add($controller->widget('common.components.web.widgets.GridViewToggleColumns', ['model' => $model, 'columns' => ['command_id', 'action', 'status', 'duration', 'memoryUsage', 'date_added']], true))
                    ->add(HtmlHelper::accessLink(IconHelper::make('refresh') . t('app', 'Refresh'), ['misc/cron_jobs_history'], ['class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Refresh')]))
                ...
                $controller->widget('zii.widgets.grid.CGridView', hooks()->applyFilters('grid_view_properties', [
                    ...
                    'columns' => hooks()->applyFilters('grid_view_columns', [
                        ...
                        [
                            'name'   => 'action',
                            'value'  => '$data->action',
                            'filter' => $model->getActionAsOptions(),
                        ],
                        [
                            'name'  => 'status',
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo t('cronjobs', 'Showing various info about all the cron jobs that run for the application. We keep latest 10 records in the history for each cron job that runs.'); ?><br />
                </div>
            </div>
        </div>
    </div>
