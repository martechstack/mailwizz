        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ...
                    ->add(HtmlHelper::accessLink(IconHelper::make('refresh') . t('app', 'Refresh'), ['campaigns/autoresponder'], ['class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Refresh')]))
                    ->render(); ?>
            </div>
        ...
        $controller->widget('zii.widgets.grid.CGridView', hooks()->applyFilters('grid_view_properties', [
                    ...
                    'columns' => hooks()->applyFilters('grid_view_columns', [
                        ...
                        [
                            ...
                            'template'          => '{quick-view} {overview} {approve} {pause} {unpause} {reset} {block} {unblock} {webversion} {marksent} {resendgiveups} {delete}',
                        ],
                    ], $controller),
                ], $controller));
    }
