        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->addIf($controller->widget('common.components.web.widgets.GridViewToggleColumns', ['model' => $tax, 'columns' => ['name', 'percent', 'country_id', 'zone_id', 'is_global', 'status', 'date_added']], true), $itemsCount)
                    ->add(HtmlHelper::accessLink(IconHelper::make('create') . t('app', 'Create new'), ['taxes/create'], ['class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Create new')]))
                    ->add(HtmlHelper::accessLink(IconHelper::make('refresh') . t('app', 'Refresh'), ['taxes/index'], ['class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Refresh')]))
                    ->render(); ?>
            </div>
    ...
    if (!empty($collection) && $collection->itemAt('renderGrid')) {
        $controller->widget('zii.widgets.grid.CGridView', hooks()->applyFilters('grid_view_properties', [
                    ...
                    'columns' => hooks()->applyFilters('grid_view_columns', [
                        ...
                        [
                            'name'  => 'is_global',
                            'value' => 'ucfirst(t("app", $data->is_global))',
                        ...
                        [
                            ...
                            'buttons'   => [
                                'update' => [
                                    ...
                                    'url'       => 'createUrl("taxes/update", array("id" => $data->tax_id))',
                                    'imageUrl'  => null,
                                ...
                                'delete' => [
                                    ...
                                    'url'       => 'createUrl("taxes/delete", array("id" => $data->tax_id))',
                                    'imageUrl'  => null,
