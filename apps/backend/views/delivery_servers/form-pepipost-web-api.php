            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php echo t('servers', 'The url where this server expects to receive webhooks requests to process bounces and complaints is: {url}!', ['{url}' => sprintf('<strong>%s</strong>', $server->getDswhUrl())]); ?><br />
                        <?php echo t('servers', 'Please go to {url} and add {webhook} for following events: Emails are bounced, Emails are unsubscribed, Emails are abuse!', [
                            '{url}'     => CHtml::link(t('servers', 'Webhooks Area'), 'https://app1.pepipost.com/index.php/settings/index#tab_3', ['target' => '_blank']),
                            '{webhook}' => sprintf('<strong>%s</strong>', $server->getDswhUrl()),
                        ]); ?>
                    </div>
                </div>
            </div>
