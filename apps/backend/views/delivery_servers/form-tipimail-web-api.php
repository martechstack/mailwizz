            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php echo t('servers', 'You can configure your TipiMail account from: {url}', [
                            '{url}' => CHtml::link('https://app.tipimail.com/#/app/settings/webhooks', 'https://app.tipimail.com/#/app/settings/webhooks', ['target' => '_blank']),
                        ]); ?>
                    </div>
                </div>
            </div>
