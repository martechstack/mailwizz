            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <br /><br />
                        <?php echo t('servers', 'You can configure your ElasticEmail account from: {url}', [
                            '{url}' => CHtml::link('https://elasticemail.com/account#/settings', 'https://elasticemail.com/account#/settings', ['target' => '_blank']),
                        ]); ?>
                        <br /><br />
                        <?php echo t('servers', 'Make sure you enable Unsubscribed, Complaints and Bounce/Error events in the HTTP Web Notifications area, including the above webhook url.'); ?>
                    </div>
                </div>
            </div>
        </div>
