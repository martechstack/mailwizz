        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php $box = BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->addIf($controller->widget('common.components.web.widgets.GridViewToggleColumns', ['model' => $server, 'columns' => ['customer_id', 'name', 'hostname', 'username', 'from_email', 'type', 'status']], true), $itemsCount)
                ...
                $instance = new $className(); ?>
                            <li>
                                <a href="<?php echo createUrl('delivery_servers/create', ['type' => $instance->type]); ?>">
                                    ...
                                    <?php if ($instance->isRecommended) { ?><span title="<?php echo t('servers', 'Recommended'); ?>"><?php echo IconHelper::make('fa-thumbs-up'); ?></span><?php } ?>
                                </a>

                                <?php if ($providerUrl = $instance->getProviderUrl()) { ?>
                                    <a href="<?php echo $providerUrl; ?>" target="_blank" title="<?php echo t('servers', 'Sign up'); ?>">
