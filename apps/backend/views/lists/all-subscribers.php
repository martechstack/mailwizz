        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->add($controller->widget('common.components.web.widgets.GridViewToggleColumns', ['model' => $filter, 'columns' => ['customer_id', 'list_id', 'subscriber_uid', 'email', 'source', 'ip_address', 'status', 'date_added', 'last_updated']], true))
