            ...
            <tr>
                <td>
                    <div class="form-group">
                        ...
                        <?php echo $form->dropDownList($filter, 'customers', $filter->getCustomersList(), $filter->fieldDecorator->getHtmlOptions('customers', ['multiple' => true, 'name' => 'customers'])); ?>
                ...
                <td>
                    <div class="form-group">
                        ...
                        <?php echo $form->dropDownList($filter, 'lists', $filter->getListsList(), $filter->fieldDecorator->getHtmlOptions('lists', ['multiple' => true, 'name' => 'lists'])); ?>
                ...
                <td>
                    <div class="form-group">
                        ...
                        <?php echo $form->dropDownList($filter, 'statuses', $filter->getStatusesList(), $filter->fieldDecorator->getHtmlOptions('statuses', ['multiple' => true, 'name' => 'statuses'])); ?>
                ...
                <td>
                    <div class="form-group">
                        ...
                        <?php echo $form->dropDownList($filter, 'sources', $filter->getSourcesList(), $filter->fieldDecorator->getHtmlOptions('sources', ['multiple' => true, 'name' => 'sources'])); ?>
                ...
                <td>
                    <div class="form-group">
                        ...
                        <?php echo $form->dropDownList($filter, 'unique', CMap::mergeArray(['' => ''], $filter->getYesNoOptions()), $filter->fieldDecorator->getHtmlOptions('unique', ['name' => 'unique'])); ?>
            ...
            <tr>
                <td>
                    <div class="form-group">
                        ...
                        <?php echo $form->dropDownList($filter, 'campaigns_action', CMap::mergeArray(['' => ''], $filter->getCampaignFilterActions()), $filter->fieldDecorator->getHtmlOptions('campaigns_action', ['name' => 'campaigns_action'])); ?>
                ...
                <td>
                    <div class="form-group">
                        ...
                        <?php echo $form->dropDownList($filter, 'campaigns', $filter->getCampaignsList(), $filter->fieldDecorator->getHtmlOptions('campaigns', ['multiple' => true, 'name' => 'campaigns'])); ?>
