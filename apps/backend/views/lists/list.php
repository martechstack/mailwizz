        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->addIf($controller->widget('common.components.web.widgets.GridViewToggleColumns', ['model' => $list, 'columns' => ['list_uid', 'customer_id', 'display_name', 'default_from_name', 'default_from_email', 'subscribers_count', 'last_updated']], true), $itemsCount && !$list->getIsArchived())
