    ...
    <div class="modal fade" id="language-upload-modal" tabindex="-1" role="dialog" aria-labelledby="language-upload-modal-label" aria-hidden="true">
        ...
        $form = $controller->beginWidget('CActiveForm', [
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary btn-flat" onclick="$('#<?php echo $languageUpload->getModelName(); ?>-upload-form').submit();"><?php echo IconHelper::make('upload') . '&nbsp;' . t('app', 'Upload archive'); ?></button>
            </div>
          </div>
        </div>
    </div>
