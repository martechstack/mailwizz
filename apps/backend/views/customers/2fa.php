...
if (!empty($viewCollection) && $viewCollection->itemAt('renderContent')) {
    ...
    <ul class="nav nav-tabs" style="border-bottom: 0px;">
        <li class="inactive"><a href="<?php echo createUrl('customers/update', ['id' => $customer->customer_id]); ?>"><?php echo html_encode(t('app', 'Profile')); ?></a></li>
        <li class="active"><a href="<?php echo createUrl('customers/2fa', ['id' => $customer->customer_id]); ?>"><?php echo html_encode(t('app', '2FA')); ?></a></li>
    </ul>
    <?php
    /**
            ...
            <div class="box-header">
                ...
                <div class="pull-right">
                    <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                        ->add(HtmlHelper::accessLink(IconHelper::make('back') . t('app', 'Back'), ['customers/update', 'id' => $customer->customer_id], ['class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Back')]))
