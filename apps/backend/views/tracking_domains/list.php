        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->addIf($controller->widget('common.components.web.widgets.GridViewToggleColumns', ['model' => $domain, 'columns' => ['customer_id', 'name', 'scheme', 'date_added', 'last_updated']], true), $itemsCount)
                    ->add(HtmlHelper::accessLink(IconHelper::make('create') . t('app', 'Create new'), ['tracking_domains/create'], ['class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Create new')]))
                    ->add(HtmlHelper::accessLink(IconHelper::make('refresh') . t('app', 'Refresh'), ['tracking_domains/index'], ['class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Refresh')]))
    ...
    if (!empty($collection) && $collection->itemAt('renderGrid')) {
        $controller->widget('zii.widgets.grid.CGridView', hooks()->applyFilters('grid_view_properties', [
                    ...
                    'columns' => hooks()->applyFilters('grid_view_columns', [
                        ...
                        [
                            'name'  => 'scheme',
                            'value' => 'strtoupper((string)$data->scheme)',
                        ...
                        [
                            ...
                            'buttons'   => [
                                'update' => [
                                    ...
                                    'url'       => 'createUrl("tracking_domains/update", array("id" => $data->domain_id))',
                                    'imageUrl'  => null,
                                ...
                                'delete' => [
                                    ...
                                    'url'       => 'createUrl("tracking_domains/delete", array("id" => $data->domain_id))',
                                    'imageUrl'  => null,
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo t('tracking_domains', 'Please note, in order for this feature to work this (sub)domain needs a dedicated IP address, otherwise all defined CNAMES for it will point to the default domain on this server.'); ?>
                    <br />
                    <strong><?php echo t('tracking_domains', 'If you do not use a dedicated IP address for this domain only or you are not sure you do so, do not use this feature!'); ?></strong>
                </div>
            </div>
        </div>
    </div>
