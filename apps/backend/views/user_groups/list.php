        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->addIf($controller->widget('common.components.web.widgets.GridViewToggleColumns', ['model' => $group, 'columns' => ['name', 'usersCount', 'date_added', 'last_updated']], true), $itemsCount)
                    ->add(HtmlHelper::accessLink(IconHelper::make('create') . t('app', 'Create new'), ['user_groups/create'], ['class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Create new')]))
                    ->add(HtmlHelper::accessLink(IconHelper::make('refresh') . t('app', 'Refresh'), ['user_groups/index'], ['class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Refresh')]))
                    ->render(); ?>
            </div>
                        ...
                        [
                            ...
                            'buttons'   => [
                                'update' => [
                                    ...
                                    'url'       => 'createUrl("user_groups/update", array("id" => $data->group_id))',
                                    'imageUrl'  => null,
                                ...
                                'delete' => [
                                    ...
                                    'url'       => 'createUrl("user_groups/delete", array("id" => $data->group_id))',
                                    'imageUrl'  => null,
