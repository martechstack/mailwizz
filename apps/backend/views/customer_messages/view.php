        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->add(HtmlHelper::accessLink(IconHelper::make('back') . t('app', 'Back'), ['customer_messages/index'], ['class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Back')]))
                    ->render();
                ?>
            </div>
            ...
            $controller->widget('zii.widgets.CDetailView', [
                ...
                'attributes' => [
                    [
                        ...
                        'value' => $message->getShortTitle(1000),
                    ],
                    [
                        'label' => $message->getAttributeLabel('message'),
                        'value' => $message->getShortMessage(5000),
                        'type'  => 'raw',
                    ],
                    [
