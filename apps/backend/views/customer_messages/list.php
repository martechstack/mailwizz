        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->add($controller->widget('common.components.web.widgets.GridViewToggleColumns', ['model' => $message, 'columns' => ['customer_id', 'title', 'message', 'status', 'date_added', 'last_updated']], true))
                    ->add(HtmlHelper::accessLink(IconHelper::make('create') . t('app', 'Create new'), ['customer_messages/create'], ['class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Create new')]))
                    ->add(HtmlHelper::accessLink(IconHelper::make('refresh') . t('app', 'Refresh'), ['customer_messages/index'], ['class' => 'btn btn-primary btn-flat', 'title' => t('app', 'Refresh')]))
                    ->render();
                ?>
            </div>
                        ...
                        [
                            ...
                            'buttons'   => [
                                'view' => [
                                    ...
                                    'url'      => 'createUrl("customer_messages/view", array("id" => $data->message_id))',
                                    'imageUrl' => null,
                                    'options'  => ['title' => t('lists', 'View'), 'class' => 'btn btn-primary btn-flat'],
                                    'visible'  => 'AccessHelper::hasRouteAccess("customer_messages/view")',
                                ],
                                'update' => [
                                    'label'     => IconHelper::make('update'),
                                    'url'       => 'createUrl("customer_messages/update", array("id" => $data->message_id))',
                                    'imageUrl'  => null,
                                ...
                                'delete' => [
                                    ...
                                    'url'       => 'createUrl("customer_messages/delete", array("id" => $data->message_id))',
                                    'imageUrl'  => null,
