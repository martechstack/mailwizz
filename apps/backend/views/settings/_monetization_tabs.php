...
<ul class="nav nav-tabs" style="border-bottom: 0px;">
    <li class="<?php echo $controller->getAction()->getId() == 'monetization' ? 'active' : 'inactive'; ?>">
        <a href="<?php echo createUrl('settings/monetization'); ?>">
            <?php echo t('settings', 'Monetization'); ?>
        </a>
    </li>
    <li class="<?php echo $controller->getAction()->getId() == 'monetization_orders' ? 'active' : 'inactive'; ?>">
        <a href="<?php echo createUrl('settings/monetization_orders'); ?>">
            <?php echo t('settings', 'Orders'); ?>
        </a>
    </li>
    <li class="<?php echo $controller->getAction()->getId() == 'monetization_invoices' ? 'active' : 'inactive'; ?>">
