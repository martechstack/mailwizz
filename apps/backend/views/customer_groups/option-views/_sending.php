        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo t('settings', 'You can find a more detailed explanation for these settings {here}.', [
                    '{here}' => CHtml::link(t('settings', 'here'), hooks()->applyFilters('customer_sending_explanation_url', 'https://kb.mailwizz.com/articles/understanding-sending-quota-limits-work/'), ['target' => '_blank']),
                ]); ?>
            </div>
        </div>
    </div>
