...
class OptionMonetizationInvoices extends OptionBase
{
     ...
     * @return string
     */
    public function getLogoUrl(int $width = 230, int $height = 130, bool $forceSize = false): string
    {
        if (empty($this->logo)) {
            return '';
        }
    ...
    public function getLogoPath(): string
    {
        ...
        $logoImage = Yii::getPathOfAlias('root') . urldecode($this->getLogoUrl());
