...
class UserPasswordReset extends ActiveRecord
{
    ...
    public function sendEmail(array $params = []): bool
    {
        ...
        $params['from'] = [$server->getFromEmail() => container()->get(OptionCommon::class)->getSiteName()];
    ...
    public function sendEmailFallback(array $params = []): bool
    {
        ...
        $params['from']      = [$email => container()->get(OptionCommon::class)->getSiteName()];
    ...
    protected function beforeSave()
    {
        if ($this->getIsNewRecord()) {
            ...
            $this->ip_address = request()->getUserHostAddress();
