...
(NULL, 'Text', 'text', 'customer.components.list-field-builder.text.ListFieldBuilderTypeText', 'Text', NOW(), NOW()),
(NULL, 'Dropdown', 'dropdown', 'customer.components.list-field-builder.dropdown.ListFieldBuilderTypeDropdown', 'Dropdown', NOW(), NOW()),
(NULL, 'Multiselect', 'multiselect', 'customer.components.list-field-builder.multiselect.ListFieldBuilderTypeMultiselect', 'Multiselect', NOW(), NOW()),
(NULL, 'Date', 'date', 'customer.components.list-field-builder.date.ListFieldBuilderTypeDate', 'Date', NOW(), NOW()),
(NULL, 'Datetime', 'datetime', 'customer.components.list-field-builder.datetime.ListFieldBuilderTypeDatetime', 'Datetime', NOW(), NOW()),
(NULL, 'Textarea', 'textarea', 'customer.components.list-field-builder.textarea.ListFieldBuilderTypeTextarea', 'Textarea', NOW(), NOW()),
(NULL, 'Country', 'country', 'customer.components.list-field-builder.country.ListFieldBuilderTypeCountry', 'Country', NOW(), NOW()),
(NULL, 'State', 'state', 'customer.components.list-field-builder.state.ListFieldBuilderTypeState', 'State', NOW(), NOW()),
(NULL, 'Checkbox List', 'checkboxlist', 'customer.components.list-field-builder.checkboxlist.ListFieldBuilderTypeCheckboxlist', 'Checkbox List', NOW(), NOW()),
(NULL, 'Radio List', 'radiolist', 'customer.components.list-field-builder.radiolist.ListFieldBuilderTypeRadiolist', 'Radio List', NOW(), NOW()),
(NULL, 'Geo Country', 'geocountry', 'customer.components.list-field-builder.geocountry.ListFieldBuilderTypeGeocountry', 'Geo Country', NOW(), NOW()),
(NULL, 'Geo State', 'geostate', 'customer.components.list-field-builder.geostate.ListFieldBuilderTypeGeostate', 'Geo State', NOW(), NOW()),
(NULL, 'Geo City', 'geocity', 'customer.components.list-field-builder.geocity.ListFieldBuilderTypeGeocity', 'Geo City', NOW(), NOW()),
(NULL, 'Checkbox', 'checkbox', 'customer.components.list-field-builder.checkbox.ListFieldBuilderTypeCheckbox', 'Checkbox', NOW(), NOW()),
(NULL, 'Consent Checkbox', 'consentcheckbox', 'customer.components.list-field-builder.consentcheckbox.ListFieldBuilderTypeConsentCheckbox', 'Consent Checkbox', NOW(), NOW()),
(NULL, 'Years Range', 'yearsrange', 'customer.components.list-field-builder.yearsrange.ListFieldBuilderTypeYearsRange', 'Years Range', NOW(), NOW()),
(NULL, 'Phone Number', 'phonenumber', 'customer.components.list-field-builder.phonenumber.ListFieldBuilderTypePhonenumber', 'Phone Number', NOW(), NOW()),
(NULL, 'Email', 'email', 'customer.components.list-field-builder.email.ListFieldBuilderTypeEmail', 'Email', NOW(), NOW()),
(NULL, 'Url', 'url', 'customer.components.list-field-builder.url.ListFieldBuilderTypeUrl', 'Url', NOW(), NOW()),
(NULL, 'Rating', 'rating', 'customer.components.list-field-builder.rating.ListFieldBuilderTypeRating', 'Rating', NOW(), NOW());
...
(NULL, 'Text', 'text', 'customer.components.survey-field-builder.text.SurveyFieldBuilderTypeText', 'Text', NOW(), NOW()),
(NULL, 'Number', 'number', 'customer.components.survey-field-builder.number.SurveyFieldBuilderTypeNumber', 'Number', NOW(), NOW()),
(NULL, 'Geo City', 'geocity', 'customer.components.survey-field-builder.geocity.SurveyFieldBuilderTypeGeocity', 'Geo City', NOW(), NOW()),
(NULL, 'Geo Country', 'geocountry', 'customer.components.survey-field-builder.geocountry.SurveyFieldBuilderTypeGeocountry', 'Geo Country', NOW(), NOW()),
(NULL, 'Geo State', 'geostate', 'customer.components.survey-field-builder.geostate.SurveyFieldBuilderTypeGeostate', 'Geo State', NOW(), NOW()),
(NULL, 'Checkbox', 'checkbox', 'customer.components.survey-field-builder.checkbox.SurveyFieldBuilderTypeCheckbox', 'Checkbox', NOW(), NOW()),
(NULL, 'Checkbox List', 'checkboxlist', 'customer.components.survey-field-builder.checkboxlist.SurveyFieldBuilderTypeCheckboxlist', 'Checkbox List', NOW(), NOW()),
(NULL, 'Radio List', 'radiolist', 'customer.components.survey-field-builder.radiolist.SurveyFieldBuilderTypeRadiolist', 'Radio List', NOW(), NOW()),
(NULL, 'Consent Checkbox', 'consentcheckbox', 'customer.components.survey-field-builder.consentcheckbox.SurveyFieldBuilderTypeConsentCheckbox', 'Consent Checkbox', NOW(), NOW()),
(NULL, 'Dropdown', 'dropdown', 'customer.components.survey-field-builder.dropdown.SurveyFieldBuilderTypeDropdown', 'Dropdown', NOW(), NOW()),
(NULL, 'Multiselect', 'multiselect', 'customer.components.survey-field-builder.multiselect.SurveyFieldBuilderTypeMultiselect', 'Multiselect', NOW(), NOW()),
(NULL, 'Date', 'date', 'customer.components.survey-field-builder.date.SurveyFieldBuilderTypeDate', 'Date', NOW(), NOW()),
(NULL, 'Datetime', 'datetime', 'customer.components.survey-field-builder.datetime.SurveyFieldBuilderTypeDatetime', 'Datetime', NOW(), NOW()),
(NULL, 'Phone Number', 'phonenumber', 'customer.components.survey-field-builder.phonenumber.SurveyFieldBuilderTypePhonenumber', 'Phone Number', NOW(), NOW()),
(NULL, 'Email', 'email', 'customer.components.survey-field-builder.email.SurveyFieldBuilderTypeEmail', 'Email', NOW(), NOW()),
(NULL, 'Url', 'url', 'customer.components.survey-field-builder.url.SurveyFieldBuilderTypeUrl', 'Url', NOW(), NOW()),
(NULL, 'Rating', 'rating', 'customer.components.survey-field-builder.rating.SurveyFieldBuilderTypeRating', 'Rating', NOW(), NOW()),
(NULL, 'Country', 'country', 'customer.components.survey-field-builder.country.SurveyFieldBuilderTypeCountry', 'Country', NOW(), NOW()),
(NULL, 'State', 'state', 'customer.components.survey-field-builder.state.SurveyFieldBuilderTypeState', 'State', NOW(), NOW()),
(NULL, 'Years Range', 'yearsrange', 'customer.components.survey-field-builder.yearsrange.SurveyFieldBuilderTypeYearsRange', 'Years Range', NOW(), NOW()),
(NULL, 'Textarea', 'textarea', 'customer.components.survey-field-builder.textarea.SurveyFieldBuilderTypeTextarea', 'Textarea', NOW(), NOW());
-- --------------------------------------------------------
