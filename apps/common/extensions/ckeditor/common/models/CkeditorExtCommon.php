...
class CkeditorExtCommon extends ExtensionModel
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ['enable_filemanager_user, enable_filemanager_customer, default_toolbar', 'required'],
            ['enable_filemanager_user, enable_filemanager_customer', 'in', 'range' => array_keys($this->getOptionsDropDown())],
    ...
    public function attributeLabels()
    {
        $labels = [
            ...
            'filemanager_theme'           => $this->t('Filemanager theme'),
        ];
