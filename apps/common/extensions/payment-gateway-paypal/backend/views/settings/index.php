         ...
         <div class="row">
             <div class="col-lg-6">
                 <div class="form-group">
                     ...
                     <?php echo $form->textField($model, 'email', $model->fieldDecorator->getHtmlOptions('email')); ?>
             ...
             <div class="col-lg-6">
                 <div class="form-group">
                     ...
                     <?php echo $form->dropDownList($model, 'mode', $model->getModes(), $model->fieldDecorator->getHtmlOptions('mode')); ?>
