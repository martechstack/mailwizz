...
class QueueProcessorCustomerListsAllSubscribersFilterUnsubscribe implements Processor
{
    /**
    ...
    public function process(Message $message, Context $context)
    {
        ...
        $filter->unsubscribeSubscribers();

        $message = new CustomerMessage();
        $message->customer_id = (int)$filter->customer_id;
        $message->title       = 'Unsubscribe subscribers';
