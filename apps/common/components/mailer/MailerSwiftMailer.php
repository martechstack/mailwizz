...
class MailerSwiftMailer extends MailerAbstract
{
    ...
    protected function setTransport(CMap $params)
    {
        ...
        // since 1.3.5.3
        $this->_transport = hooks()->applyFilters('mailer_after_create_transport_instance', $this->_transport, $params->toArray(), $this);
        $this->_mailer    = hooks()->applyFilters('mailer_after_create_mailer_instance', $this->_mailer, $params->toArray(), $this);
...
//        $message->setFrom('yu.destroyer.ok@gmail.com', $fromName);
        ...
        $message->getHeaders()->addTextHeader(sprintf('%sMailer', app_param('email.custom.header.prefix', '')), 'SwiftMailer - 5.4.x');
        ...
        // since 1.3.5.3
        $this->_message = hooks()->applyFilters('mailer_after_create_message_instance', $message, $params->toArray(), $this);
