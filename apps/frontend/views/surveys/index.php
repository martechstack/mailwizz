...
<div class="row">
    <div class="<?php echo $controller->layout != 'embed' ? 'col-lg-6 col-lg-push-3 col-md-6 col-md-push-3 col-sm-12' : ''; ?>">
        <?php echo CHtml::form('', 'post', $htmlOptions); ?>
        <div class="box box-primary borderless">
            <div class="box-header">
                <h3 class="box-title"><?php echo $survey->getDisplayName(); ?></h3>
            </div>
